...
# Первая покупка (нет активного премиум-пасса) активирует на 30 дней, дальнейшие,
# пока пасс ещё активен, продлевают на 20 дней каждая — так сказал пользователь,
# в отличие от подписки, где каждая покупка одинаково добавляет 30 дней.
BATTLE_PASS_FIRST_DURATION_DAYS = 30
BATTLE_PASS_EXTEND_DURATION_DAYS = 20
