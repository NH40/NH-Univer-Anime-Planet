from bot.config.game.game import (
    BATTLE_PASS_BASE_DUST_PER_LEVEL,
    BATTLE_PASS_BOOST_TIER_LEVELS,
    BATTLE_PASS_BOOST_TIER_MULTIPLIERS,
    BATTLE_PASS_COIN_MILESTONE_MOD,
    BATTLE_PASS_COST_ENDLESS,
    BATTLE_PASS_COST_START,
    BATTLE_PASS_CYCLE_LEVELS,
    BATTLE_PASS_MAJOR_BONUS_COEF,
    BATTLE_PASS_MAJOR_MILESTONE_MOD,
    BATTLE_PASS_MILESTONE_COINS,
    BATTLE_PASS_MILESTONE_TICKETS,
    BATTLE_PASS_MINOR_BONUS_COEF,
    BATTLE_PASS_MINOR_MILESTONE_MOD,
